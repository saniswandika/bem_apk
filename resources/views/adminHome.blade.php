...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet"  href="{{ asset('vendors/owl-carousel-2/owl-carousel-2/owl.carousel.min.css') }}">
  ...
  <body>
    ...
    <script src ="{{ asset('vendors/progressbar.js/progress.min.js') }}"></script>
